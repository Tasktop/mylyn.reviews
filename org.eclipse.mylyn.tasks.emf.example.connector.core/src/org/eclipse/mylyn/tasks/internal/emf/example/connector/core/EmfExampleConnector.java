 ...
 *******************************************************************************/
package org.eclipse.mylyn.tasks.internal.emf.example.connector.core;
 ...
 * @author Miles Parker
 */
public class EmfExampleConnector extends AbstractEmfConnector {
	...
	private final EAttribute[] SEARCH_ATTRIBUTES = new EAttribute[] { EmfTasksPackage.Literals.SIMPLE_TASK__SUMMARY,
			EmfTasksPackage.Literals.SIMPLE_TASK__DESCRIPTION, EmfTasksPackage.Literals.SIMPLE_TASK__PRIORITY,
			EmfTasksPackage.Literals.SIMPLE_TASK__STATUS, EmfTasksPackage.Literals.SIMPLE_TASK__DUE_DATE,
	...
	public EAttribute getTaskIdAttribute() {
		return EmfTasksPackage.Literals.SIMPLE_TASK__ID;
	}
