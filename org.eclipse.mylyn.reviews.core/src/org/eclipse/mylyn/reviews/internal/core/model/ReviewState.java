 ...
 * <ul>
 *   <li>{@link org.eclipse.mylyn.reviews.internal.core.model.ReviewState#isEnabled <em>Enabled</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ReviewState extends EObjectImpl implements IReviewState {
	...
	public void setEnabled(boolean newEnabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReviewsPackage.REVIEW_STATE__ENABLED, oldEnabled,
					enabled));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ReviewsPackage.REVIEW_STATE__ENABLED:
			return isEnabled();
		}
