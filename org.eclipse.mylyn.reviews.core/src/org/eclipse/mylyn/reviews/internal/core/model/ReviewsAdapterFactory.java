...
public class ReviewsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ReviewsSwitch<Adapter> modelSwitch = new ReviewsSwitch<Adapter>() {
		...
		@Override
		public Adapter caseEnableable(IEnableable object) {
		...
		@Override
		public Adapter caseCommented(ICommented object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.mylyn.reviews.core.model.IEnableable <em>Enableable</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.mylyn.reviews.core.model.ICommented <em>Commented</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
