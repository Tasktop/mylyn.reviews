...
package org.eclipse.mylyn.tasks.emf.connector.query;

import org.eclipse.osgi.util.NLS;

public class Messages extends NLS {
	private static final String BUNDLE_NAME = "org.eclipse.mylyn.tasks.emf.connector.query.messages"; //$NON-NLS-1$
	static {
