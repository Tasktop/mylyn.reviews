 ...
 *******************************************************************************/
package org.eclipse.mylyn.tasks.emf.connector.ui;
...
public abstract class EmfRepositorySettingsPage extends AbstractTaskRepositoryPage {
	...
	protected void createSettingControls(Composite parent) {
		...
		Button browseButton = new Button(uriButtonPanel, SWT.BORDER);
		...
		createButton = new Button(uriButtonPanel, SWT.BORDER);
