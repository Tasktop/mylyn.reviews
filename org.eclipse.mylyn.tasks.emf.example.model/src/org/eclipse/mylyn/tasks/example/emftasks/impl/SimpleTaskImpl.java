/**
 */
package org.eclipse.mylyn.tasks.example.emftasks.impl;
...
import org.eclipse.mylyn.tasks.example.emftasks.Category;
import org.eclipse.mylyn.tasks.example.emftasks.EmfTasksPackage;
import org.eclipse.mylyn.tasks.example.emftasks.Priority;
import org.eclipse.mylyn.tasks.example.emftasks.SimpleTask;
import org.eclipse.mylyn.tasks.example.emftasks.Status;
 ...
 * <ul>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getPriority <em>Priority</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getDueDate <em>Due Date</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getCompletionDate <em>Completion Date</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getCreationDate <em>Creation Date</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getModificationDate <em>Modification Date</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getCollaborators <em>Collaborators</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getRelatedUrl <em>Related Url</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getRanking <em>Ranking</em>}</li>
 *   <li>{@link org.eclipse.mylyn.tasks.example.emftasks.impl.SimpleTaskImpl#getCategory <em>Category</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
