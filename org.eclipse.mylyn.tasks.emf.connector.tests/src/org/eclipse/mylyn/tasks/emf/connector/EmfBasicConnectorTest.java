...
import org.eclipse.mylyn.tasks.emf.connector.support.EmfTestConnector;
...
public class EmfBasicConnectorTest extends TestCase {
	...
	public void testGetTasKeyFromTaskId() {
		...
		assertThat(enDashString, is(not(hyphenString))); //$NON-NLS-1$ 
		assertThat(enDashString, is(connector.getTaskKeyFromTaskId(hyphenString))); //$NON-NLS-1$ 
	}
